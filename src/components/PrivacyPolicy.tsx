      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-lg shadow-slate-100/50 relative overflow-hidden space-y-8">
        ...
        <div className="space-y-6 text-sm text-slate-600 leading-relaxed font-sans">
          <p className="text-base text-slate-700">
            แอปพลิเคชัน <strong>"Tong Matra (ท่องมาตรา)"</strong> มุ่งมั่นที่จะปกป้องข้อมูลส่วนบุคคลของคุณ นโยบายความเป็นส่วนตัวนี้จัดทำขึ้นเพื่ออธิบายวิธีการเก็บรวบรวม การใช้งาน และการเปิดเผยข้อมูลของคุณในฐานะผู้ใช้งาน เมื่อคุณเลือกลงชื่อเข้าใช้ด้วยบัญชี Google (Google OAuth)
          </p>
          ...
          <section className="space-y-3 bg-amber-50/50 border border-amber-100 p-4 rounded-2xl">
            ...
            <p className="text-xs text-amber-800 leading-relaxed">
              การใช้งานข้อมูลที่ได้รับจาก Google APIs ของแอปพลิเคชัน "Tong Matra (ท่องมาตรา)" จะเป็นไปตามข้อกำหนดนโยบายสิทธิ์ข้อมูลผู้ใช้บริการ API ของ Google ซึ่งรวมถึงข้อกำหนดสำหรับการใช้งานที่จำกัดอย่างเคร่งครัด (Limited Use Requirements) ข้อมูลของคุณจะไม่ถูกนำไปใช้โฆษณา ค้ากำไร หรือพิจารณาการให้สินเชื่อเด็ดขาด
            </p>
          </section>
