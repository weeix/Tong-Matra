      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-lg shadow-slate-100/50 relative overflow-hidden space-y-8">
        ...
        <div className="space-y-6 text-sm text-slate-600 leading-relaxed font-sans">
          <p className="text-base text-slate-700 font-medium">
            ยินดีต้อนรับสู่แอปพลิเคชัน <strong>"ท่องมาตรา" (Tong Matra)</strong> กรุณาอ่านเงื่อนไขการใช้บริการนี้โดยละเอียดก่อนเข้าใช้งาน การที่ท่านเริ่มเข้าใช้งานระบบ หมายถึงท่านยอมรับเงื่อนไขและข้อตกลงเหล่านี้ทุกประการ
          </p>
          ...
          <section className="space-y-2">
            ...
            <p>
              แอปพลิเคชัน "ท่องมาตรา" เป็นระบบจำลองการวางระยะเวลาและสร้างหัวข้อตารางเรียนรู้ (Spaced Repetition System: SRS) สำหรับช่วยจำประมวลกฎหมายเพื่อวัตถุประสงค์ทางการศึกษา กฎหมาย แนะนำแนวทางเรียนรู้ และความจำส่วนบุคคลเท่านั้น ไม่ใช่บริการที่ปรึกษาทางกฎหมายอย่างเป็นทางการ
            </p>
          </section>
